...
# Перехватываем все сообщения и убираем проверку подписки
from aiogram.types import ChatMemberStatus

# Добавляем middleware для отключения проверки подписки
@dp.message()
async def check_subscription_middleware(message: types.Message, state: FSMContext):
    """Пропускаем все сообщения без проверки подписки"""
    # Просто передаем управление дальше
    return

logger.info("✅ Проверка подписки ОТКЛЮЧЕНА!")
# ============================================================
